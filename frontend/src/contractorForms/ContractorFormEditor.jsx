...
/** Standard editable fields for a contractor form before print/save. */
export default function ContractorFormEditor({ formId, values, onChange, showCommon = true }) {
