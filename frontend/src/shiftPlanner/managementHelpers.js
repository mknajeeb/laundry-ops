...
export function columnsFromCheckpoint(checkpoint) {
  ...
  const waitingPhrase = (n, label) => {
    ...
    const dest = String(label).trim().toUpperCase();
    return `${n} AVAILABLE FOR ${dest}`;
  };
  return stageList.map((s) => {
    ...
    return {
      ...
      isTerminal,
      terminalText: isTerminal ? "complete" : null,
    ...
    columns = [
      {
        ...
        waitingNextText: `${n("waiting_to_sort")} AVAILABLE FOR SORT`,
      ...
      },
      {
        ...
        waitingNextText: `${n("waiting_to_wash")} AVAILABLE FOR WASH`,
      ...
      },
      {
        ...
        waitingNextText: `${n("waiting_to_dry")} AVAILABLE FOR DRY`,
      ...
      },
      {
        ...
        waitingNextText: `${n("waiting_to_fold")} AVAILABLE FOR FOLD`,
