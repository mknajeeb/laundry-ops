...
export const getScanChronology = (params = {}, config = {}) =>
  axios.get(`${API_BASE}/rinse/shift-analysis/scan-chronology`, {
    params,
    timeout: 60000,
    ...config,
  });
...
export const getShiftCapacityPlannerSettings = () =>
  axios.get(`${API_BASE}/rinse/shift-analysis/shift-capacity-planner/settings`, { timeout: 15000 });
...
export const reopenPaidForCorrection = (batchId, reason) =>
  axios.post(`${API_BASE}/api/ta/payroll/payout-batches/${batchId}/reopen-paid-for-correction`, {
    reason,
  });
...
export const getManagementTodaySuppliesDetail = (dateEt, params = {}) => {
  const { signal, ...rest } = params || {};
  return axios.get(`${API_BASE}/api/management/today/supplies/detail`, {
    params: { date_et: dateEt, ...rest },
    signal,
    timeout: 120000,
  });
...
export const getRinseDashboardOverview = (params = {}) =>
  axios.get(`${API_BASE}/api/rinse-dashboard/performance/overview`, {
    params,
    timeout: 60000,
  });

export const getRinseDashboardRoles = (params = {}) =>
  axios.get(`${API_BASE}/api/rinse-dashboard/performance/roles`, {
    params,
    timeout: 60000,
  });
...
export const getRinseDashboardDaily = (params = {}) =>
  axios.get(`${API_BASE}/api/rinse-dashboard/performance/daily`, {
    params,
    timeout: 60000,
  });

export const getRinseDashboardEmployees = (params = {}) =>
  axios.get(`${API_BASE}/api/rinse-dashboard/performance/employees`, { params, timeout: 60000 });
