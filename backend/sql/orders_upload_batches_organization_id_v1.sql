...
SET @sql = IF(@exists = 0,
  'ALTER TABLE orders_staging ADD COLUMN organization_id INT NOT NULL DEFAULT 1 COMMENT ''Tenant FK'' AFTER id',
...
SET @sql = IF(@exists = 0,
  'ALTER TABLE upload_batches ADD COLUMN organization_id INT NOT NULL DEFAULT 1 COMMENT ''Tenant FK'' AFTER id',
...
SET @sql = IF(@tbl_orders_final = 0,
  ...
  IF(@exists = 0,
    'ALTER TABLE orders_final ADD COLUMN organization_id INT NOT NULL DEFAULT 1 COMMENT ''Tenant FK'' AFTER id',
