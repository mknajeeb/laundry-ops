...
from backend.supply_product_master_routes import register_supply_product_master_routes
...
# Inventory routes registered via register_inventory_routes() at app startup.
...
def confirm_upload_batch(batch_id):
    ...
    try:
        ...
        try:
            payload = confirm_upload_batch_core(
                cursor,
                tenant_oid,
                batch_id,
...
register_supply_product_master_routes(
    app,
    require_user=require_user,
    require_admin_or_ops=require_admin_or_ops,
    user_org_id=user_org_id,
...
register_management_revenue_routes(
    app,
    require_user=require_user,
    user_org_id=user_org_id,
    parse_date_value=parse_date_value,
)
register_management_revenue_accounts_routes(
    app,
    require_user=require_user,
    user_org_id=user_org_id,
)
